package com.anr.bookstore.notifications.events;
...
import com.anr.bookstore.notifications.AbstractIT;
import com.anr.bookstore.notifications.ApplicationProperties;
import com.anr.bookstore.notifications.domain.models.Address;
import com.anr.bookstore.notifications.domain.models.Customer;
import com.anr.bookstore.notifications.domain.models.OrderCancelledEvent;
import com.anr.bookstore.notifications.domain.models.OrderCreatedEvent;
import com.anr.bookstore.notifications.domain.models.OrderDeliveredEvent;
import com.anr.bookstore.notifications.domain.models.OrderErrorEvent;
...
class OrderEventHandlerTests extends AbstractIT {
    ...
    Customer customer = new Customer("anr", "anr@gmail.com", "999999999");
    Address address = new Address("addr line 1", null, "Bengalore", "TS", "560010", "India");
