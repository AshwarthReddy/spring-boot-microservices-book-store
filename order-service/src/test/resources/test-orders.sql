...
insert into orders (id,order_number,username,
                    ...
                    status,comments) values
                                         (1, 'order-123', 'anr', 'Siva', 'anr@gmail.com', '11111111', '123 Main St', 'Apt 1', 'Dallas', 'TX', '75001', 'USA', 'NEW', null),
                                         (2, 'order-456', 'anr', 'Prasad', 'banr20@gmail.com', '2222222', '123 Main St', 'Apt 1', 'bengalore', 'TS', '560010', 'India', 'NEW', null)
;
